...
## 1. Barrier Option Pricing: see BarrierOptionPricing-Heston-MonteCarlo.py
...
## 2. Machine Learning Pricing of Barrier Options (Honors Research): see NN_w_constraints.ipynb
